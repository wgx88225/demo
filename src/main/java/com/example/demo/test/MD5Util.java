 ...
 * @Description
 * @Author Vince
 * @CreateTime 2021年10月18日 15:47:00
 */
...
public class MD5Util {
    ...
    public static void main(String[] args) throws IOException {
        File file = new File("E:\\download\\卡士按下图.png");
        ...
        String key = DigestUtils.md5Hex(buffer);
        System.out.println("key1:" + key); // a6481049c898b6e30299d18ae7ba47de

        String key2 = DigestUtils.md5Hex(fis2);
        System.out.println("key2:" + key2); // 5de26e4f24f97f9a8cb89643a701eade
        String key3 =generateMD5(file.getAbsolutePath());
        System.out.println("key3:" + key3); // a6481049c898b6e30299d18ae7ba47de
